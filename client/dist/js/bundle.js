...
exports["default"] = void 0;
var _Injector = _interopRequireDefault(__webpack_require__(/*! lib/Injector */ "lib/Injector"));
var _readAnyFieldDescription = _interopRequireDefault(__webpack_require__(/*! state/anyFieldDescription/readAnyFieldDescription */ "./client/src/state/anyFieldDescription/readAnyFieldDescription.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
const registerQueries = () => {
  _Injector.default.query.register('readAnyFieldDescription', _readAnyFieldDescription.default);
};
...
/***/ "./client/src/components/AbstractAnyField/AbstractAnyField.js":
/*!********************************************************************!*\
  !*** ./client/src/components/AbstractAnyField/AbstractAnyField.js ***!
  \********************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports["default"] = exports.anyFieldPropTypes = void 0;
var _react = _interopRequireWildcard(__webpack_require__(/*! react */ "react"));
var _Injector = __webpack_require__(/*! lib/Injector */ "lib/Injector");
var _propTypes = _interopRequireDefault(__webpack_require__(/*! prop-types */ "prop-types"));
var _AllowedDataObjectClass = _interopRequireDefault(__webpack_require__(/*! ../../types/AllowedDataObjectClass */ "./client/src/types/AllowedDataObjectClass.js"));
var _AnyFieldSummary = _interopRequireDefault(__webpack_require__(/*! ../../types/AnyFieldSummary */ "./client/src/types/AnyFieldSummary.js"));
...
const AbstractAnyField = _ref => {
  ...
  if (loading) {
    return _react.default.createElement(_AnyFieldBox.default, null, _react.default.createElement(Loading, null));
  }
  ...
  const onClear = (event, recordId) => {
    if (typeof onChange === 'function') {
      onChange(event, {
        id,
        value: JSON.stringify(clearData(recordId))
      });
    }
  };
  const pickerProps = {
  ...
  const onModalSubmit = submittedData => {
    ...
    if (typeof onChange === 'function') {
      onChange(undefined, {
        id,
        value: JSON.stringify(updateData(newDataObject))
      });
    }
    setEditingId(false);
...
AbstractAnyField.propTypes = {
  ...anyFieldPropTypes,
  clearData: _propTypes.default.func.isRequired,
  buildProps: _propTypes.default.func.isRequired,
  updateData: _propTypes.default.func.isRequired,
  selectData: _propTypes.default.func.isRequired
};
var _default = AbstractAnyField;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/AbstractAnyField/anyFieldHOC.js":
/*!***************************************************************!*\
  !*** ./client/src/components/AbstractAnyField/anyFieldHOC.js ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.stringifyData = exports["default"] = void 0;
...
const anyFieldHOC = (0, _redux.compose)(stringifyData, (0, _Injector.injectGraphql)('readAnyFieldDescription'), _hoc.withApollo, _FieldHolder.default);
var _default = anyFieldHOC;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/AnyField/AnyField.js":
/*!****************************************************!*\
  !*** ./client/src/components/AnyField/AnyField.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var _Injector = __webpack_require__(/*! lib/Injector */ "lib/Injector");
var _propTypes = _interopRequireDefault(__webpack_require__(/*! prop-types */ "prop-types"));
var _AnyFieldData = _interopRequireDefault(__webpack_require__(/*! ../../types/AnyFieldData */ "./client/src/types/AnyFieldData.js"));
var _AbstractAnyField = _interopRequireWildcard(__webpack_require__(/*! ../AbstractAnyField/AbstractAnyField */ "./client/src/components/AbstractAnyField/AbstractAnyField.js"));
var _anyFieldHOC = _interopRequireDefault(__webpack_require__(/*! ../AbstractAnyField/anyFieldHOC */ "./client/src/components/AbstractAnyField/anyFieldHOC.js"));
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function (nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || typeof obj !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _extends() { _extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
var _default = (0, _redux.compose)((0, _Injector.inject)(['AnyPicker', 'Loading'], (AnyPicker, Loading) => ({
  Picker: AnyPicker,
  Loading
})), _anyFieldHOC.default)(AnyField);
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/AnyFieldBox/AnyFieldBox.js":
/*!**********************************************************!*\
  !*** ./client/src/components/AnyFieldBox/AnyFieldBox.js ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const AnyFieldBox = _ref => {
  ...
  return _react.default.createElement("div", {
    className: (0, _classnames.default)('any-field-box', 'form-control', className),
    "data-anyfield-id": id
  }, children);
};
...
var _default = AnyFieldBox;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/AnyModal/AnyModal.js":
/*!****************************************************!*\
  !*** ./client/src/components/AnyModal/AnyModal.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const buildSchemaUrl = (key, data) => {
  const {
    schemaUrl
  } = _Config.default.getSection(leftAndMain).form.AnyField;
...
var _default = AnyModal;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/AnyModal/FileAnyModal.js":
/*!********************************************************!*\
  !*** ./client/src/components/AnyModal/FileAnyModal.js ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var _default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(FileAnyModal);
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/AnyPicker/AnyPicker.js":
/*!******************************************************!*\
  !*** ./client/src/components/AnyPicker/AnyPicker.js ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var _propTypes = _interopRequireDefault(__webpack_require__(/*! prop-types */ "prop-types"));
var _classnames = _interopRequireDefault(__webpack_require__(/*! classnames */ "classnames"));
var _AnyPickerMenu = _interopRequireDefault(__webpack_require__(/*! ./AnyPickerMenu */ "./client/src/components/AnyPicker/AnyPickerMenu.js"));
var _AnyPickerTitle = _interopRequireDefault(__webpack_require__(/*! ./AnyPickerTitle */ "./client/src/components/AnyPicker/AnyPickerTitle.js"));
var _AnyFieldBox = _interopRequireDefault(__webpack_require__(/*! ../AnyFieldBox/AnyFieldBox */ "./client/src/components/AnyFieldBox/AnyFieldBox.js"));
var _AllowedDataObjectClass = _interopRequireDefault(__webpack_require__(/*! ../../types/AllowedDataObjectClass */ "./client/src/types/AllowedDataObjectClass.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
/***/ "./client/src/components/AnyPicker/AnyPickerMenu.js":
/*!**********************************************************!*\
  !*** ./client/src/components/AnyPicker/AnyPickerMenu.js ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
AnyPickerMenu.propTypes = {
  allowedDataObjectClasses: _propTypes.default.arrayOf(_AllowedDataObjectClass.default).isRequired,
  onSelect: _propTypes.default.func.isRequired
};
var _default = AnyPickerMenu;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/components/AnyPicker/AnyPickerTitle.js":
/*!***********************************************************!*\
  !*** ./client/src/components/AnyPicker/AnyPickerTitle.js ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const AnyPickerTitle = _ref => {
  ...
  }, dataObjectClass.title, description && _react.default.createElement(_react.Fragment, null, ":\xA0", _react.default.createElement("span", {
...
const ManyAnyField = props => {
  const staticProps = {
    ...
    updateData: newDataObject => {
      ...
      return newDataObject.ID ? data.map(oldDataObject => oldDataObject.ID === newDataObject.ID ? newDataObject : oldDataObject) : [...data, {
        ...newDataObject,
        ID: (0, _uuid.v4)(),
        isNew: true
      }];
...
var _react = _interopRequireDefault(__webpack_require__(/*! react */ "react"));
var _propTypes = _interopRequireDefault(__webpack_require__(/*! prop-types */ "prop-types"));
var _AnyPickerMenu = _interopRequireDefault(__webpack_require__(/*! ../AnyPicker/AnyPickerMenu */ "./client/src/components/AnyPicker/AnyPickerMenu.js"));
var _AnyPickerTitle = _interopRequireDefault(__webpack_require__(/*! ../AnyPicker/AnyPickerTitle */ "./client/src/components/AnyPicker/AnyPickerTitle.js"));
var _AnyFieldBox = _interopRequireDefault(__webpack_require__(/*! ../AnyFieldBox/AnyFieldBox */ "./client/src/components/AnyFieldBox/AnyFieldBox.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _extends() { _extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
/***/ "./client/src/state/anyFieldDescription/readAnyFieldDescription.js":
/*!*************************************************************************!*\
  !*** ./client/src/state/anyFieldDescription/readAnyFieldDescription.js ***!
  \*************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./client/src/types/AllowedDataObjectClass.js":
/*!****************************************************!*\
  !*** ./client/src/types/AllowedDataObjectClass.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var _propTypes = _interopRequireDefault(__webpack_require__(/*! prop-types */ "prop-types"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
const AllowedDataObjectClass = _propTypes.default.shape({
  key: _propTypes.default.string.isRequired,
  icon: _propTypes.default.string,
  title: _propTypes.default.string.isRequired,
  modalHandler: _propTypes.default.string
});
var _default = AllowedDataObjectClass;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/types/AnyFieldData.js":
/*!******************************************!*\
  !*** ./client/src/types/AnyFieldData.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./client/src/types/AnyFieldSummary.js":
/*!*********************************************!*\
  !*** ./client/src/types/AnyFieldSummary.js ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var _propTypes = _interopRequireDefault(__webpack_require__(/*! prop-types */ "prop-types"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
const AnyFieldSummary = _propTypes.default.shape({
  title: _propTypes.default.string,
  description: _propTypes.default.string
});
var _default = AnyFieldSummary;
exports["default"] = _default;
